...
​
    ...
    def update_counter(self):
        ...
        if timepassed < 10:
            self.currCount += 1
            self.count12[11] = self.currCount + self.count12[10]*(10-timepassed)/10
        else:
            shift = timepassed//10
            self.timestamp = timepassed % 10
            ...
            for i in range(shift):
                self.count12[11-i] = 0
            self.currCount = 1
            self.count12[11] = self.currCount + self.count12[10]*(10-max(timepassed, 10))/10
​
